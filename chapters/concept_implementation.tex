...
\begin{enumerate}
    ...
    \item \textbf{Spatial Memory Query:} Before searching for the destination, the agent queries the Blackboard. If the location of the matching delivery zone (e.g., \texttt{Red Zone}) was discovered and cached during a previous traversal or was given by the user, the search phase is skipped.
