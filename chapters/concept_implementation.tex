...
When the system operates in Robot-in-the-Loop (RitL) mode, the \texttt{PoseRobotController} assumes control. In this configuration, the virtual robot ceases to be a dynamic agent and becomes a kinematic shadow of the physical EMAROs~\cite{EMAROs_Ref} robot (FR-07).
