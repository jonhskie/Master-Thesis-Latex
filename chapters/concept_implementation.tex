...
\begin{enumerate}
    ...
    \item \textbf{ExecuteCoverage:} The robot drives the generated path. During this phase, the tool that the robot equipped, modifies the ground texture using raycasts.
