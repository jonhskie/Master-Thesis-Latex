...
For the VR interface (\hyperref[req:FR-16]{FR-16}), the visual output from Unity is streamed via Wi-Fi to the Meta Quest Pro headset using ALVR~\cite{ALVR_Github}, an open-source streaming solution. This setup allows the user to move freely without a cable tether.
