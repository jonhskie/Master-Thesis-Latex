...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        (b) Attached State
    \end{minipage}
    \caption{Debug view of the Logistics application. The processor identifies a blue transport box in its ROI (green) and calculates the centroid (red dot).}
    \label{fig:logistics_debug}
\end{figure}
\cite{hieer die unterschrieft adnerd und erwähneung im text}
...
\end{figure}
\cite{hieer die unterschrieft adnerd und erwwähnung im text}
