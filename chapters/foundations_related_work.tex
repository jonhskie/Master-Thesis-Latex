...
\begin{figure}[h]
    ...
    \caption{The physical setup of the VERA platform, featuring a ceiling-mounted projector and tracking system above the test area. (Source: \cite{Geh24})}
...
\begin{figure}[h]
    ...
    \caption{The EMARO robot serves as the physical twin in the system, equipped with a modular sensor suite and running ROS~2. (Source: \cite{Geh24})}
...
\begin{figure}[h]
    ...
    \caption{The original VERA visualization rendered via Pygame, projecting the robot's path and virtual obstacles onto the floor. (Source: \cite{Geh24})}
