...
To overcome these limitations, this thesis proposes integrated the \textbf{Unity Engine} \cite{Uni23} into the architecture of VERA using the \textbf{Robot Operating System 2 (ROS~2)} \cite{macenski2023survey}. Unity is chosen because it offers advanced physics simulation through PhysX, sophisticated rendering and a mature framework framework for creation in MR \cite{Singh2025, Gonzalez2025}. All of these target the shortcomings of the past system \cite{Geh24}. Using the \texttt{ros2-for-unity} asset ensures low-latency, high-throughput synchronization between the physical and virtual world \cite{Rob24}.
