...
\begin{itemize}
    ...
    \item \textbf{NFR-03: Component Independence:} The system architecture must allow for individual components to be added, removed, or changed without breaking the overall application.
