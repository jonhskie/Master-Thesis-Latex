...
\begin{itemize}
    ...
    \item \textbf{FR-10: Coordinate Transforms:} The system shall publish dynamic coordinate transforms representing the motion of the robot.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{NFR-02: Frame Rate:} The simulation shall maintain a constant target frame rate (at least 60 FPS) to avoid simulator sickness in VR \cite{Chang20102020} and to ensure that AR projections remain visually stable and aligned with the physical environment.    
