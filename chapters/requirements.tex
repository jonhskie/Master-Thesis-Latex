...
\begin{itemize}
    ...
    \item \textbf{FR-02: Physics Simulation:}\label{req:FR-02} Overcoming the limitations in the previous VERA framework, the engine shall provide a physics system that will be able to resolve mass, friction, collision, and drag to simulate physical interactions such as a robot pushing obstacles.
