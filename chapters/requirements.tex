...
\begin{itemize}
    ...
    \item \textbf{NFR-02: Frame Rate:}\label{req:NFR-02} The simulation shall maintain a constant target frame rate (at least 60 Frames Per Second (FPS)) to avoid simulator sickness in VR~\cite{Chang20102020} and to ensure that AR projections remain visually stable and aligned with the physical environment.    
