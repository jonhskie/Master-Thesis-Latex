...
These requirements specify capabilities related to the virtual environment itself, such as generation of sensor data and mechanisms for dynamic interaction and visualization.
\begin{itemize}
    ...
    \item \textbf{FR-13: Dynamic Environment Interaction:} The system shall allow dynamic manipulation of the environment, including physical pushing and attaching of objects, modification of object states, and changes of surface textures at runtime.
